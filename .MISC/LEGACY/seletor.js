import { COMPONENTES_HTML, MOEDAS } from "../moedas.js";
...
export class Seletor {
  ...
  inverterMoedas(moedas) {
    [COMPONENTES_HTML.seletor1.value, COMPONENTES_HTML.seletor2.value] = [
      COMPONENTES_HTML.seletor2.value,
      COMPONENTES_HTML.seletor1.value,
    ];
